...
In this module, you will deploy backend application components to 2 AWS Regions (Ireland and Singapore). These backend components include 3 AWS Lambda functions, 2 API Gateway Endpoints and DynamoDB Global Table per Region. 
